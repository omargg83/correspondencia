...
?>
		...
		<form id='consulta_avanzada' action='' data-destino='a_corresps/lista' data-div='resultado' data-funcion='avanzada' autocomplete='off'>
			<div class='row'>
				<div class='col-sm-2'>
					<label>Desde:</label>
				...
				<div class='col-sm-3'>
					...
					<select id='documento' name='documento' class='form-control'>
						...
						<option value='circular'>Oficio circular</option>
						<option value='comision'>Oficio de comisión</option>
					</select>
				</div>
			...
			*Solo se muestran los primeros 300 registros de la busqueda
		</form>
	</div>
	<hr>
